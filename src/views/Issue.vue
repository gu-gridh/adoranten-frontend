...
onMounted(async () => {
  ...
  try {
    ...
    const response = await fetch(`http://127.0.0.1:8000/api/v2/pages/?type=journal.ArticlePage&child_of=${issueId}&fields=image,article_title,article_description,pdf_file`)
